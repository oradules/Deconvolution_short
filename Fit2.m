...
DataFilePath0 = '/home/mdouaihy/Artificial_data_2021/doroso_all_parameters/experimental_S_function/2_states_april_2021';
mkdir(DataFilePath0);
xlsfilename = [DataFilePath0,'/results.xlsx'];
%xlswrite(xlsfilename,{'Data','k1p','k1m','k2','p1','p2','Obj','KS test','Nuclei','Frames'},1,'A1')

writecell({'Data','lambda1','lambda2','A1','A2','k1p','k1m','k2','Obj','KS test'},xlsfilename)
res=[];
par_noise=[];
...
fname=[DataFilePath0,'/ecdf_Result_april_2021_',name,'_cens_',num2str(cens),'.mat'];
...
nn=size(DataExp);
%%%% optimal
res= [k1p,k1m,k2,k1m/(k1m+k1p),k1p/(k1m+k1p),objmin,aa,nn(2),nn(1)];
