...
MatFilePath = '/home/mdouaihy/Artificial_data_2021/doroso_all_parameters/matResult/matresultfiles/';  
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
pooled =0; %%%% if this is 1, pool all the result files from MatFilePath
%%%%%%%%%%%%%%% if not, use each file separately%%%%%%%%%%%%%%%%%%%%%%%%

%%%%% where to write the output files
DataFilePath0 = '/home/mdouaihy/Artificial_data_2021/doroso_all_parameters/experimental_S_function/3_states';
mkdir(DataFilePath0);
...
%     'lambda1','lambda2','lambda3','A1','A2','A3','S1','Obj','KS test','Nuclei','Frames'},1,'A1')


writecell({'Data','M1:k1p','M1:k1m','M1:k2p','M1:k2m','M1:k3','M1:p1','M1:p2','M1:p3','M2:k1p','M2:k1m','M2:k2p','M2:k2m','M2:k3','M2:p1','M2:p2','M2:p3',...
    'lambda1','lambda2','lambda3','A1','A2','A3','S1','Obj','KS test','Nuclei','Frames'},xlsfilename)
...
iend = strfind(fname,'.mat');
name = fname(8:iend-1);
name=strrep(name,'dataset_','');
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
fup=fup(1:end-1);
%%%%%%%%%%%%%%%%%%%%%%%%%%
fname=[DataFilePath0,'/ecdf_Result_',name,'_cens_',num2str(cens),'.mat'];
save(fname,'xs','fs','flo','fup')
...
nn=size(DataExp);
%%%% optimal
res= [k1p,k1m,k2p,k2m,k3,p1,p2,p3,kk1p,kk1m,kk2p,kk2m,kk3,pp1,pp2,pp3,l1,l2,l3,A1,A2,A3,S1,objmin,aa,nn(2),nn(1)]; %%%% optimum
